            ...
            <Layout>
                        ...
                        <div className="banner-1">
                            <div className="row align-items-center">
                                <div className="col-lg-7">
                                    <h1 className="color-brand-1 mb-20">Iori dashboard will help your payments fast and secure</h1>
                                    <div className="row">
                                        <div className="col-lg-9">
                                            <p className="font-md color-grey-500">Social media networks are open to all. Social media is typically used for social interaction and access to news and information, and decision making.</p>
                                        </div>
                                    </div>
                                    <div className="mt-30">
                    ...
                    <div className="container">
                        <div className="box-radius-logo">
                            <div className="text-center">
                                <p className="font-lg color-brand-1">Loved By Developers, Trusted By Enterprises</p>
                            </div>
                            <div className="mt-30">
                    ...
                    <div className="container">
                        <div className="row mt-50 align-items-center">
                            <div className="col-lg-6 mb-30">
                                ...
                                <h2 className="color-brand-1">We facilitate the creation of strategy and design</h2>
                            </div>
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    <div className="card-image"><img src="assets/imgs/page/homepage2/we-do3.png" alt="iori" /></div>
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><a className="color-brand-1" href="What makes us different from others? We give holistic solutions with strategy, design & technology.">Employee Assessments</a></h4>
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><a className="color-brand-1" href="No lag time, no lost effort when priorities change, no email black hole. As team collaboration improves">Smart Installation Tools</a></h4>
                                        <p className="font-md color-grey-500 mb-5">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                        <div className="box-button-offer"><a className="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                                            <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><a className="color-brand-1" href="Share updates instantly within our project management software, and get the entire team collaborating">Collaborative to the core.</a></h4>
                                        <p className="font-md color-grey-500 mb-5">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                        <div className="box-button-offer"><a className="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                                            <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><a className="color-brand-1" href="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files.">Manage budgets and resources</a></h4>
                                        <p className="font-md color-grey-500 mb-5">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                        <div className="box-button-offer"><a className="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                                            <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><a className="color-brand-1" href="What makes us different from others? We give holistic solutions with strategy, design & technology.">Unlimited ways to work</a></h4>
                                        <p className="font-md color-grey-500 mb-5">Your site is not complete with only landings. Get essential inner pages using our ready demos.</p>
                                        <div className="box-button-offer"><a className="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                                            <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                        ...
                        <div className="box-button text-center mt-10"> <Link className="btn btn-brand-1 hover-up" href="#">Download App</Link><Link className="btn btn-default font-sm-bold hover-up" href="#">
                            Learn More
                            <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            </svg></Link></div>
                        ...
                        <div className="row mt-50 align-items-center">
                            <div className="col-lg-6">
                                <div className="box-images-project">
                                    <div className="box-images"> <img className="img-main-2" src="assets/imgs/page/homepage2/img2.png" alt="iori" />
                                        <div className="shape-1 image-4"> <img src="assets/imgs/page/homepage2/certify.png" alt="iori" /></div>
                                        <div className="shape-2 image-5"> <img src="assets/imgs/page/homepage2/fly.png" alt="iori" /></div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="title-line mb-10">How to start?</div>
                                <h2 className="color-brand-1 mb-40">Bring your target users together on social media</h2>
                ...
                <section className="section mt-50 bg-plan-2 pt-110 pb-110">
                    <div className="container">
                        ...
                        <div className="row mt-50">
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="card-plan card-plan-2 hover-up">
                                    ...
                                    <div className="box-day-trial box-trial-two">
                                        <div className="trial-col-1"><span className="font-lg-bold color-brand-1">FREE</span><span className="font-md color-grey-500">- 30 days trial<br /></span><span className="font-xs color-grey-500">No Credit card required</span></div>
                                        <div className="trial-col-2"><Link className="btn btn-brand-1-full hover-up" href="#">Try for free
                                    ...
                                    <div className="mt-20"><Link className="btn btn-default font-sm-bold" href="#">Learn More
                                        <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                        </svg></Link></div>
                                </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="card-plan card-plan-2 hover-up">
                                    ...
                                    <div className="box-day-trial box-trial-two">
                                        <div className="trial-col-1"><span className="font-lg-bold color-brand-1 text-price-standard">${pricing == 1 ? "29" : "348"}</span><span className="font-md color-grey-500 text-type-standard">- user / month</span><br /><span className="font-xs color-grey-500">Billed annually</span></div>
                                        <div className="trial-col-2"><Link className="btn btn-brand-1-full hover-up" href="#">Get Started
                                            <svg className="w-6 h-6 icon-16 ml-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                            </svg></Link></div>
                                    </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6">
                                <div className="card-plan card-plan-2 hover-up">
                                    <div className="card-image-plan">
                                        <div className="icon-plan bg-2"><img src="assets/imgs/page/homepage2/creation.png" alt="iori" /></div>
                                        <div className="info-plan">
                                    ...
                                    <div className="box-day-trial box-trial-two">
                                        <div className="trial-col-1"><span className="font-lg-bold color-brand-1 text-price-enterprise">${pricing == 1 ? "299" : "3,588"}</span><span className="font-md color-grey-500 text-type-enterprise">- user / month</span><br /><span className="font-xs color-grey-500">Billed annually</span></div>
                                        <div className="trial-col-2"><Link className="btn btn-brand-1-full hover-up" href="#">Get Started
                                            <svg className="w-6 h-6 icon-16 ml-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                            </svg></Link></div>
                        ...
                        <div className="box-button text-center mt-20"> <Link className="btn btn-brand-1 hover-up" href="#">Contact Us</Link><Link className="btn btn-default font-sm-bold hover-up" href="#">
                            Compare Plans
                            <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                            </svg></Link></div>
