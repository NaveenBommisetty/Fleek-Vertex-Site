...
const BlogDetails = () => {
    return (
        <>
            <Head>
                <title>The Betty Crocker Secret to an Email Marketing Strategy People Enjoy</title>
            </Head>
                        ...
                        <div className="row">
                            <div className="col-xl-9 col-lg-8">
                                <div className="content-single">
                                    <h2 className="color-brand-5 mb-50">The Betty Crocker Secret to an Email Marketing Strategy People Enjoy</h2>
