              ...
              <div className="row">
                <div className="col-lg-10 col-11 m-auto">
                  <div className="box-detail-content">
                    <h3 className="color-brand-1 mb-10 mt-0">Front-end Developer</h3>
                    ...
                    <div className="box-info-job">
                      <div className="item-job">
                        ...
                        <div className="right-info">HTML5, CSS, JS, React, Python</div>
                      </div>
                      <div className="item-job">
                    ...
                    <ul>
                      <li>Develop user-facing applications</li>
                    ...
                    <ul>
                      ...
                      <li>Strong understanding of web technologies</li>
                    </ul>
