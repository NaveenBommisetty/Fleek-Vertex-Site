          ...
          <div className="container">
            <div className="breadcrumbs">
              <ul>
                ...
                <li>
                  <Link href="#">MobileApp Developer</Link>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-lg-10 col-11 m-auto">
                  <div className="box-detail-content">
                    <h3 className="color-brand-1 mb-10 mt-0">MobileApp Developer</h3>
                    ...
                    <div className="box-info-job">
                      <div className="item-job">
                        ...
                        <div className="right-info">Flutter,React Native,Swift,Kotlin</div>
                      </div>
                      <div className="item-job">
                    ...
                    <ul>
                      <li>Design and develop mobile applications</li>
                      <li>Collaborate with cross-functional teams to define, design, and ship new features</li>
                    </ul>

                    <h4 className="color-brand-1">Requirements</h4>
                    <ul>
                      <li>Experience with Flutter or React Native</li>
