...
const HowJiraEnhancesWebSoftwareDevelopmentProjects = () => {
    return (
        <>
            <Head>
                <title>How JIRA Enhances Web and Software Development Projects</title>
            </Head>
                    ...
                    <div className="container">
                        <div className="breadcrumbs ">
                            <ul>
                                ...
                                <li> <Link href="#">How JIRA Enhances Web and Software Development Projects</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
export default HowJiraEnhancesWebSoftwareDevelopmentProjects;